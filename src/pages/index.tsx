        ...
        {(inputCardVisible || !isStoryGenerated) && (
          ...
          >
            <motion.div
              ...
              exit={{ y: "-100%" }}
              transition={{ duration: 0.5, ease: "easeInOut" }}
              className="py-3 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto"
            >
              <div className="relative bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 rounded-lg shadow-lg p-8">
